import 'package:donate/screens/item_description.dart';
...
import '../provider/getItemDetails.dart';
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Consumer<DonationItems>(builder: ((context, value, child) {
            value.getNGODonationDetails(context);
            return Column(
              children: [
                Container(
                ...
                Container(
                    ...
                    width: 350,
                    decoration: const ShapeDecoration(
                        color: Color.fromARGB(255, 233, 140, 171),
                        shape: RoundedRectangleBorder(
                            borderRadius:
